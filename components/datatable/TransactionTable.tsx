  ...
  // category column
  {
    ...
    cell: ({ row }) => (
      <div className="flex gap-2 capitalize">
        ...
        <div className="capitalized">{row.original.category}</div>
      </div>
    ),
  },
...
function TransactionTable({ from, to }: TransactionTableProps) {
  ...
  // function to get unique value of each category
  const categoriesOptions = useMemo(() => {
    const categoriesMap = new Map();

    // iterate for each value of history
    ...
    // get the categories with unique values
      ...
      <div className="flex flex-wrap items-end justify-between  gap-2 py-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Button
            ...
            onClick={() => {
              // create a data table to be sent in csv
